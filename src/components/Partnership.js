      ...
      <div className="text-left">
        ...
        <div className="flex w-full my-4">
          <div className="border rounded w-2/5 p-4 text-sm h-fit">
            <div className="hidden peer-active/domino:visible">
              <div>
            ...
            <div className="hidden peer-active/sic:block">
              <div>
          ...
          <div className="w-3/5 mx-10 justify-center flex flex-wrap gap-6 ">
            <div
              id="domino"
              active
              className="peer-active/domino:bg-slate-400 w-1/4 p-3 rounded-xl border h-20 flex justify-center active:border-red-700 items-center hover:scale-110 shadow-xl transform transition duration-500 "
            >
              <img src="https://intrex.pl/wp-content/uploads/2023/03/Projekt-bez-tytulu-17.png"></img>
            </div>
            <div
              id="sic"
              className="peer-active/sic w-1/4 p-3 rounded-xl border h-20 flex justify-center items-center hover:scale-110 shadow-xl transform transition duration-500 "
            >
              <img src="https://intrex.pl/wp-content/uploads/2023/03/Projekt-bez-tytulu-17.png"></img>
            </div>
            <div className="w-1/4 p-3 rounded-xl border h-20 flex justify-center items-center hover:scale-110 shadow-xl transform transition duration-500 ">
              <img src="https://intrex.pl/wp-content/uploads/2023/03/Projekt-bez-tytulu-17.png"></img>
            </div>
            <div className="w-1/4 p-3 rounded-xl border h-20 flex justify-center items-center hover:scale-110 shadow-xl transform transition duration-500 ">
              <img src="https://intrex.pl/wp-content/uploads/2023/03/Projekt-bez-tytulu-17.png"></img>
