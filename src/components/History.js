...
<div className='text-center'>
        ...
        <p className='text-xs'>Poznaj naszą historię oraz ścieżkę rozwoju naszej organizacji. Naszym silnikiem napędowym zawsze byli ludzie i innowacje, co wyznajemy od samych początków istnienia Intrex.</p>
